...
func TestDecodeMovMem16Reg16WithSegmentOverride(t *testing.T) {
	...
	dest := mem16Disp16{offset: 0x0038}
	src := reg16{value: BX}
	expected := instMov{dest: dest, src: src}
	if actual != expected {
		t.Errorf("expected %v but actual %v", expected, actual)
...
func TestDecodeMovMem16SregWithSegmentOverride(t *testing.T) {
	...
	dest := mem16Disp16{offset: 0x0032}
	src := sreg{value: DS}
	expected := instMov{dest: dest, src: src}
	if actual != expected {
		t.Errorf("expected %v but actual %v", expected, actual)
...
func TestDecodeMovMMoffs16Ax(t *testing.T) {
	...
	dest := mem16Disp16{offset: 0x0042}
	src := reg16{value: AX}
	expected := instMov{dest: dest, src: src}
	if actual != expected {
		t.Errorf("expected %v but actual %v", expected, actual)
...
func TestDecodeMovMem16Imm16(t *testing.T) {
	...
	dest := mem16Disp16{offset: 0x005e}
	src := imm16{value: 0x2000}
	expected := instMov{dest: dest, src: src}
	if actual != expected {
		t.Errorf("expected %v but actual %v", expected, actual)
	}
...
func TestDecodeMovMem16Disp8Imm16(t *testing.T) {
	...
	dest := mem16BaseDisp8{base: BP, disp8: -2}
	src := imm16{value: 0x0002}
	expected := instMov{dest: dest, src: src}
	if actual != expected {
		t.Errorf("expected %v but actual %v", expected, actual)
	}
...
func TestDecodeMovMem16Disp8Reg16(t *testing.T) {
	...
	dest := mem16BaseDisp8{base: BP, disp8: -4}
	src := reg16{value: AX}
	expected := instMov{dest: dest, src: src}
	if actual != expected {
		t.Errorf("expected %v but actual %v", expected, actual)
